...
public class PhysicalTestActivity extends AppCompatActivity implements SensorEventListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eT_waktu = findViewById(R.id.eT_waktuenamwt);
        eT_km = findViewById(R.id.eT_km);
        btn_track = findViewById(R.id.btn_track);
        btn_test = findViewById(R.id.btn_lanjut_physical_hasil);
    ...
    private void inputData() {
        ...
        if (age.isEmpty()) {
            ...
            DocumentReference documentReference = fStore.collection("6mwt").document();
            ...
            documentReference.set(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void unused) {
                    Toast.makeText(PhysicalTestActivity.this, "Berhasil input data 6mwt", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(PhysicalTestActivity.this, HasilTestActivity.class);
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(PhysicalTestActivity.this, "Gagal Menambahkan Data physical", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void stopSensorRegistration(){
        if (stepCounterSensor != null){
            ...
            float stepLengthMeters = 0.78f;
            float distanceInMeters = stepCount * stepLengthMeters;
            Log.d("Step Count", "stopSensorRegistration: " + stepCount);
            DecimalFormatSymbols symbols = new DecimalFormatSymbols(Locale.getDefault());
            symbols.setDecimalSeparator('.');
            DecimalFormat decimalFormat = new DecimalFormat("#0.00", symbols);
            String formattedDistance = decimalFormat.format(distanceInMeters);
